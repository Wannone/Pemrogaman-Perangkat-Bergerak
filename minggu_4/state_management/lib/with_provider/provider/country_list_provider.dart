...
class CountryPlaceListProvider extends StatefulWidget {
  const CountryPlaceListProvider({Key? key}) : super(key: key);

  @override
  State<CountryPlaceListProvider> createState() =>
      _CountryPlaceListProviderState();
}

class _CountryPlaceListProviderState extends State<CountryPlaceListProvider> {
    ...
    return ListView.builder(
      itemBuilder: (context, index) {
        ...
        return InkWell(
          ...
          child: Consumer(builder: (context, DoneCountryProvider data, Widget) {
            return ListItem(
                place: place,
                isDone: data.doneCountryList.contains(place),
                onCheckboxClick: (bool? value) {
                  setState(() {
                    if (value != null) {
                      value
                          ? data.doneCountryList.add(place)
                          : data.doneCountryList.remove(place);
                    }
                  });
                });
          }),
